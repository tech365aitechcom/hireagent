...
const GetStartedComp = () => {
  ...
  return (
    <div className="bg-[#2563EB] flex flex-col lg:flex-row items-center justify-center py-16 max-md:mt-6">
      <div className="w-full max-w-6xl px-4 md:px-6 lg:px-8 xl:px-12">
        <div className="space-y-8 text-center">
          <div className="space-y-4">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-extrabold bg-clip-text text-white leading-tight">
              Ready to Automate Your Real Estate Business?
            </h1>
            <p className="text-base md:text-lg lg:text-xl font-semibold text-gray-200">
              Join thousands of successful real estate agents who have
              transformed their business with AI assistance.
            </p>
          </div>
          <div className="flex justify-center">
            <button
              onClick={() => setActiveCard(aiBot.id)}
              className="gap-2 font-medium text-lg w-fit px-8 py-4 text-blue-600 bg-white rounded-lg border-2 border-blue-600 hover:bg-white flex items-center justify-center sm:justify-start transition-colors"
            >
